...
const RunningMiniGame = ({ navigation }) => {
    ...
    return (_jsx(ImageBackground, { source: runningBackground, style: styles.backgroundImage, children: _jsxs(View, { style: styles.container, children: [_jsx(Text, { style: styles.headerText, children: "Sprint Taps" }), _jsxs(Text, { style: styles.timerText, children: ["Time: ", timer, "s"] }), _jsxs(Text, { style: styles.scoreText, children: ["Score: ", score] }), !isGameOver && (_jsxs(View, { style: styles.speedMeterContainer, children: [_jsx(Animated.View, { style: [
                            ...
                            ] })] })), _jsx(TouchableOpacity, { style: [styles.tapZone, isGameOver && styles.disabledTapZone], onPress: handleTap, disabled: isGameOver, children: _jsx(Text, { style: styles.tapZoneText, children: isGameOver ? 'Game Over' : 'Tap to Run!' }) }), isGameOver && (_jsxs(View, { style: styles.gameOverContainer, children: [_jsxs(Text, { style: styles.scoreText, children: ["High Score: ", highScore] }), _jsx(TouchableOpacity, { style: styles.backButton, onPress: backToGym, children: _jsx(Text, { style: styles.backButtonText, children: "Back To Gym" }) })] }))] }) }));
};
