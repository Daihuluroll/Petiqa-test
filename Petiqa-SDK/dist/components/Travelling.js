...
const TravellingScreen = ({ navigation }) => {
    ...
    const renderTravellingOptions = () => {
        return travelItems.map((item, index) => (_jsx(TouchableOpacity, { onPress: () => handleSelectLocation(item.name), children: _jsxs(View, { style: styles.itemContainer, children: [_jsx(Image, { source: item.icon, style: styles.itemIcon }), _jsx(Text, { style: styles.itemText, children: item.name }), _jsxs(View, { style: styles.priceContainer, children: [_jsx(Image, { source: require('../../assets/images/Coin.png'), style: styles.coinIcon }), _jsx(Text, { style: styles.priceText, children: item.price })] })] }) }, index)));
    };
    return (_jsxs(View, { style: styles.container, children: [_jsx(FastImage, { style: styles.background, source: require('../../assets/images/travelBG.jpeg'), resizeMode: FastImage.resizeMode.cover }), _jsx(Text, { style: styles.headerText, children: "Travelling" }), _jsx(Text, { style: styles.subHeaderText, children: "Take your pet around the world!" }), oid && _jsx(GetPetStatus, { oid: oid, onEnergyFetch: setEnergyValue, onHappinessFetch: setHappinessValue, onHungerFetch: setHungerValue, onHealthFetch: setHealthValue }), oid && _jsx(CheckCoin, { oid: oid, onCoinFetch: setUserCoins }), _jsx(TouchableOpacity, { style: styles.backButton, onPress: handleBackButton, children: _jsx(Image, { source: require('../../assets/images/back_arrow_icon.png'), style: styles.backIcon }) }), _jsx(View, { style: styles.travelOptionsContainer, children: renderTravellingOptions() }), _jsx(Modal, { animationType: "slide", transparent: true, visible: notEnoughEnergyModalVisible, onRequestClose: () => setNotEnoughEnergyModalVisible(false), children: _jsx(View, { style: styles.modalContainer, children: _jsxs(View, { style: styles.modalContent, children: [_jsx(Text, { style: styles.modalText, children: "You don't have enough energy to travel!" }), _jsx(TouchableOpacity, { style: styles.closeButton, onPress: () => setNotEnoughEnergyModalVisible(false), children: _jsx(Text, { style: styles.modalButtonText, children: "Close" }) })] }) }) }), _jsx(Modal, { animationType: "slide", transparent: true, visible: modalVisible, onRequestClose: () => setModalVisible(false), children: _jsx(View, { style: styles.modalContainer, children: _jsxs(View, { style: styles.modalContent, children: [_jsxs(Text, { style: styles.modalText, children: ["Are you sure you want to travel to ", selectedLocation, "?"] }), _jsxs(View, { style: styles.modalButtonContainer, children: [_jsx(TouchableOpacity, { style: styles.modalButton, onPress: () => setModalVisible(false), children: _jsx(Text, { style: styles.modalButtonText, children: "No" }) }), _jsx(TouchableOpacity, { style: styles.modalButton, onPress: confirmTravel, children: _jsx(Text, { style: styles.modalButtonText, children: "Yes" }) })] })] }) }) })] }));
};
