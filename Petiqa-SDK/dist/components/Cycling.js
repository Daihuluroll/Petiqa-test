...
import { View, Text, StyleSheet, PanResponder, Animated, TouchableOpacity, Easing, ImageBackground, } from 'react-native';
...
const CyclingGame = ({ navigation }) => {
    ...
    const panResponder = PanResponder.create({
        ...
        onPanResponderMove: (_, gestureState) => {
            const normalizedVelocity = Math.sqrt(gestureState.vx * gestureState.vx + gestureState.vy * gestureState.vy) * 100;
    ...
    return (_jsxs(ImageBackground, { source: backgroundImage, style: styles.backgroundImage, children: [_jsx(View, { style: styles.opacityLayer }), _jsxs(View, { style: styles.container, children: [_jsx(Text, { style: styles.headerText, children: "Cycling Challenge" }), _jsxs(Text, { style: styles.timerText, children: ["Time: ", timeLeft, "s"] }), _jsxs(Text, { style: styles.scoreText, children: ["Score: ", score] }), !isGameOver && (_jsxs(_Fragment, { children: [_jsxs(View, { style: styles.speedMeterContainer, children: [_jsx(Animated.View, { style: [
                                        ...
                                        ] })] }), _jsx(View, { ...panResponder.panHandlers, style: styles.wheelContainer, children: _jsx(Animated.Image, { source: wheelImage, style: [
                                        styles.wheel,
                                        {
                                            transform: [
                                                {
                                    ...
                                    ] }) })] })), isGameOver && (_jsxs(View, { style: styles.gameOverContainer, children: [_jsx(Text, { style: styles.gameOverText, children: "Time's up!" }), _jsxs(Text, { style: styles.scoreText, children: ["High Score: ", highScore] }), _jsx(TouchableOpacity, { style: styles.backButton, onPress: backToGym, children: _jsx(Text, { style: styles.backButtonText, children: "Back To Gym" }) })] }))] })] }));
};
