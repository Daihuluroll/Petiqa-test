...
const WeightliftingGame = ({ navigation }) => {
    ...
    return (_jsx(ImageBackground, { source: weightBg, style: styles.backgroundImage, children: _jsxs(View, { style: styles.container, children: [_jsx(Text, { style: styles.headerText, children: "Weightlifting Challenge" }), _jsxs(Text, { style: styles.scoreText, children: ["Perfect Lifts: ", score] }), !isGameOver && (_jsxs(_Fragment, { children: [_jsxs(View, { style: styles.progressBarContainer, children: [_jsx(Animated.View, { style: [
                                        styles.progressBar,
                                        {
                                    ...
                                    ] })] }), _jsx(TouchableOpacity, { style: [styles.holdButton, isHolding && styles.holdButtonActive], onPressIn: handlePressIn, onPressOut: handlePressOut, disabled: isGameOver, children: _jsx(Text, { style: styles.buttonText, children: isHolding ? 'Lifting...' : 'Hold to Lift' }) })] })), isGameOver && (_jsxs(View, { style: styles.gameOverContainer, children: [_jsx(Text, { style: styles.gameOverText, children: "Game Over!" }), _jsxs(Text, { style: styles.scoreText, children: ["High Score: ", highScore] }), _jsx(TouchableOpacity, { style: styles.backButton, onPress: backToGym, children: _jsx(Text, { style: styles.backButtonText, children: "Back To Gym" }) })] }))] }) }));
};
