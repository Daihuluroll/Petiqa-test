...
const QuizScreen = ({ navigation }) => {
    ...
    if (hasCompletedQuiz) {
        return (_jsxs(View, { style: styles.container, children: [_jsx(FastImage, { style: styles.background, source: require('../../assets/images/mainMenuBG2.jpeg'), resizeMode: "cover" }), _jsxs(View, { style: styles.quizBox, children: [_jsx(Text, { style: styles.tryagaintext, children: "You already tried your quiz today, try again tomorrow!" }), _jsx(TouchableOpacity, { style: styles.finishButton, onPress: handleBackButton, children: _jsx(Text, { style: styles.buttonText, children: "Back to Main Menu" }) })] })] }));
    }
    return (_jsxs(View, { style: styles.container, children: [_jsx(FastImage, { style: styles.background, source: require('../../assets/images/mainMenuBG2.jpeg'), resizeMode: "cover" }), !quizComplete ? (_jsxs(View, { style: styles.quizBox, children: [_jsx(Text, { style: styles.headerText, children: "Daily Quiz" }), _jsx(Text, { style: styles.questionText, children: questions[currentQuestionIndex]?.question }), _jsx(View, { style: styles.answerContainer, children: questions[currentQuestionIndex]?.answers.map((answer, index) => (_jsx(TouchableOpacity, { style: [
                                styles.answerButton,
                                selectedAnswer === answer ? styles.selectedAnswerButton : {},
                            ], onPress: () => handleAnswerPress(answer), disabled: !!feedback, children: _jsx(Text, { style: styles.answerText, children: answer }) }, index))) }), oid && _jsx(CheckCoin, { oid: oid, onCoinFetch: setUserCoins }, refreshKey), feedback && (_jsxs(View, { style: styles.feedbackContainer, children: [_jsx(Text, { style: styles.feedbackText, children: feedback }), _jsx(TouchableOpacity, { style: styles.nextButton, onPress: handleNextQuestion, children: _jsx(Text, { style: styles.buttonText, children: "Next Question" }) })] }))] })) : (_jsxs(View, { style: styles.quizBox, children: [_jsx(Text, { style: styles.headerText, children: "Quiz Complete!" }), _jsxs(Text, { style: styles.finalScoreText, children: ["Your final score is: ", score, "/", questions.length] }), _jsxs(TouchableOpacity, { style: styles.finishButton, onPress: handleReward, children: [_jsx(Text, { style: styles.buttonText, children: "Finish Quiz" }), _jsxs(Text, { style: styles.rewardText, children: ["You earned ", score * 5, " coins!"] })] })] })), _jsx(TouchableOpacity, { style: styles.backArrowButton, onPress: handleBackButton, children: _jsx(FastImage, { source: require('../../assets/images/back_arrow_icon.png'), style: styles.backArrowIcon, resizeMode: "contain" }) })] }));
};
