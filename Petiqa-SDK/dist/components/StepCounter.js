...
const StepCounterScreen = ({ navigation, route }) => {
    const { petName: initialPetName, character: initialCharacter } = (route.params || {});
    ...
    return (_jsxs(View, { style: styles.container, children: [_jsx(FastImage, { style: styles.backgroundImage, source: require('../../assets/images/movingbackground.gif'), resizeMode: "cover" }), _jsxs(View, { style: styles.overlay, children: [_jsx(View, { style: styles.stepCounterBar, children: _jsxs(Text, { style: styles.stepCounterBarText, children: ["Steps: ", steps] }) }), _jsx(View, { style: styles.animalContainer, children: _jsx(FastImage, { source: getPetImage(character), style: styles.animalImage, resizeMode: "contain" }) }), modalVisible && (_jsx(Modal, { transparent: true, animationType: "fade", onRequestClose: () => setModalVisible(false), children: _jsx(TouchableOpacity, { style: styles.modalOverlay, onPress: () => setModalVisible(false), children: _jsx(View, { style: styles.modalContent, children: _jsx(Text, { style: styles.modalText, children: fact }) }) }) })), _jsx(TouchableOpacity, { style: styles.backArrowButton, onPress: handleBackButton, children: _jsx(Image, { source: require('../../assets/images/back_arrow_icon.png'), style: styles.backArrowIcon, resizeMode: "contain" }) })] })] }));
};
