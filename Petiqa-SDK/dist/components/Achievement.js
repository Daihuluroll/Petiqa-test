...
const AchievementScreen = ({ navigation }) => {
    ...
    const checkAchievements = async () => {
        const updatedAchievements = await Promise.all(achievements.map(async (achievement) => {
    ...
    return (_jsxs(View, { style: styles.container, children: [_jsx(FastImage, { style: styles.background, source: require('../../assets/images/mainMenuBG2.jpeg'), resizeMode: FastImage.resizeMode.cover }), _jsxs(View, { style: styles.achievementBox, children: [_jsx(Text, { style: styles.headerText, children: "Achievement" }), oid && _jsx(CheckPoint, { oid: oid, onPointFetch: setUserPoints }), _jsx(FastImage, { source: require('../../assets/images/achievement.png'), style: styles.trophyIcon, resizeMode: FastImage.resizeMode.contain }), _jsx(ScrollView, { style: styles.scrollView, contentContainerStyle: styles.achievementListContainer, children: achievements.map((item, index) => (_jsxs(View, { style: styles.achievementItem, children: [_jsxs(View, { style: styles.textContainer, children: [_jsx(Text, { style: styles.achievementText, children: item.achievement }), _jsx(Text, { style: styles.descriptionText, children: item.description })] }), item.completed ? (_jsx(FastImage, { source: require('../../assets/images/check.png'), style: styles.checkIcon, resizeMode: FastImage.resizeMode.contain })) : (_jsxs(View, { style: styles.rewardContainer, children: [_jsx(FastImage, { source: require('../../assets/images/Cash.png'), style: styles.coinIcon, resizeMode: FastImage.resizeMode.contain }), _jsx(Text, { style: styles.rewardText, children: item.reward })] }))] }, index))) })] }), _jsx(TouchableOpacity, { style: styles.backArrowButton, onPress: handleBackButton, children: _jsx(FastImage, { source: require('../../assets/images/back_arrow_icon.png'), style: styles.backArrowIcon, resizeMode: FastImage.resizeMode.contain }) })] }));
};
